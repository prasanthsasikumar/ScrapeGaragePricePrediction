...
def train_xgboost_model(file_path, model_save_dir, show_plots=False, n_estimators=100, learning_rate=0.1, max_depth=6):
    """Trains an XGBoost model to predict car prices."""
    ...
    model = Pipeline([
        ...
        ('regressor', XGBRegressor(random_state=42, n_estimators=n_estimators, learning_rate=learning_rate, max_depth=max_depth))
    ])
    ...
    print(f"XGBoost model trained and saved to {model_save_path} as {model_name}.")
